...
const page = (props: Props) => {
  ...
  **Last Updated: May 4, 2024**
  ...
  Archie AI, Inc. (“Archie AI,” “we,” “our,” or “us”) respects your privacy and is committed to protecting it through our compliance with this Privacy Policy (“Policy”). A core element of our mission is our commitment to protect your personal information and to be transparent about the data we collect about you, how it is used, and with whom it is shared.
  
  This Policy describes our practices for collecting, using, maintaining, protecting, and disclosing your information through <http://getarchieai.com> (our “Website”), our applications (our “Apps”), and our products, services, technology platforms, and related applications (collectively, the “Service(s)”).
  ...
  **Information Received from Third Parties**
  ...
  - **GitHub/GitLab Details:** We may collect data necessary to enable your Archie AI account to interface with your GitHub account, such as your GitHub token, your user organization, your GitHub username, and your user role. We integrate tightly with GitHub's API and Open Authentication (OAUTH) system. We do not have access to your GitHub/GitLab credentials.
  ...
  - To communicate with you and to promote products, services, offers, and events offered by Archie AI.
  ...
  - **Contractual Necessity:** To provide you with the Archie AI Service and perform the contract that you have with us.
  ...
  - **For Our Service Integrations:** We allow for a variety of Service integrations to provide you with the best possible functionality while using our Services. For example, we integrate with:
    ...
    - OpenAI. Google Gemini and Anthropic for various features.
      ...
      - Neither of these model providers uses personal information collected as part of Archie usage to to train, refine, or otherwise influence our models or any third-party models.
  ...
  - **For Corporate Transactions:** Archie AI may share information, including Personal Information, with any current or future subsidiaries or affiliates, primarily for business and operational purposes, in connection with a merger, acquisition, reorganization, or sale of assets (including, in each case, as part of the due-diligence process with any potential acquiring entity) or in the event of bankruptcy.
  - **If Required By Law:** Archie AI will disclose information about you to government or law enforcement officials or private parties as we, in our sole discretion, believe necessary or appropriate to respond to claims and legal processes (including but not limited to subpoenas), or, at the request of governmental authorities or other third parties conducting an investigation where we determine in our sole discretion the disclosure is necessary to (a) protect the property and rights of Archie AI or a third party, (b) protect the safety of the public or any person, or (c) prevent or stop activity we may consider to be, or pose a risk of being, illegal, fraudulent, unethical, or legally actionable activity.
  ...
  - **Contact Us:** You may contact us to access, update, or delete your personal information by contacting us at ajitesh@getarchieai\[dot\]com.
  ...
  **European Residents**
  ...
  Under the General Data Protection Regulation (GDPR), Archie AI may be considered a data controller to the extent that we process personal information directly from European residents. To the extent that Archie AI is a data controller, European residents may access, correct, update, or delete their personal information; object to our processing of this information; ask us to restrict our processing of their personal information; or request portability of their personal information by accessing the account settings within the App or by contacting us at ajitesh@getarchieai\[dot\]com.
  
  Upon request, Archie AI will provide you with information about whether we hold any of your personal information. You are responsible for maintaining the accuracy of the information you submit to us, such as your contact information. If you submit a request to access all personal information you’ve submitted, we will respond to your request within 30 days or as otherwise required by law.
  
  We will use commercially reasonable efforts to honor your requests for deletion; however, certain residual information may actively persist on the Service even if you close your account. In addition, the rights described above may be limited, for example, if fulfilling your request would reveal personal information about another person, or if you ask us to delete information we are required by law to keep or have compelling legitimate interests in keeping (such as for fraud prevention purposes). Your Personal Information may remain in our archives and information you update or delete, or information within a closed account, may persist internally for our administrative purposes, to the extent permitted by law. It is not always possible to completely remove or delete information from our databases. In addition, we typically will not remove information you posted publicly through or on the Service. Bear in mind that neither you nor Archie AI can delete all copies of information that have been previously shared with others on the Service. If your information is deleted, then your account may become deactivated. If your account is deactivated or you ask to close your account, you will no longer be able to use the Services.
  
  Please note that our Services require a minimum amount of Personal Information in order to function. European residents who do not provide Personal Information (e.g., by not creating an account) may not be able to access the full functionality of features found on Archie AI.
  
  **California Residents**
  
  If you are a California resident, the California Consumer Privacy Act (CCPA) may provide you with additional privacy rights with respect to our collection, use, and disclosure of your Personal Information. To the extent that Archie AI is a covered business under the CCPA, you may contact us for more information regarding the following rights:
  ...
  **Data Storage for Review Improvement**
  ...
  Archie AI stores certain data to improve the service, refining them to align with your preferences. You can opt out of data storage. The stored data primarily consists of vector embeddings, which are critical for fetching specific code chunks and metadata to help with code explanation, actionable suggestion and review.
