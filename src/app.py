...
def generate_prompt(your_role, candidate_role, perf_question, your_review):
    ...
    Your answer
    - Q2: Mention the first question in question for performance
    Your answer
    - Q3: Mention the first question in question for performance
    Your answer
...
if st.button('Write Review'):
    review = generate_review(your_role, candidate_role, perf_question, your_review, your_openai_key)
    st.markdown(review)
2